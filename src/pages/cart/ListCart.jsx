...
const ListCart = ({show,handleClose,cartProducats}) => {
      ...
      <Offcanvas show={show} onHide={handleClose} placement="end">
        ...
        <Offcanvas.Body>
          ...
          {cartProducats==0?(<div className='d-flex flex-column justify-content-center align-items-center'>  <FcShop className='cartIcon'/>
             ...
             <div className=' w-100'>{cartProducats.map((cartProducat)=>(<Cart key={cartProducat.id} cartProducat={cartProducat}/>))}</div>
             )}
